CREATE OR REPLACE FUNCTION public._usage_combo_rows(p_request_id bigint, p_professional_id bigint, p_task text)
 RETURNS TABLE(in_record_id bigint, quantity numeric, rn integer)
 LANGUAGE sql
 STABLE
AS $function$
    ...
    WHERE u.ref_requests_in_record_id = p_request_id
      ...
      AND ( u.ref_users_in_record_id_owner     = p_professional_id
