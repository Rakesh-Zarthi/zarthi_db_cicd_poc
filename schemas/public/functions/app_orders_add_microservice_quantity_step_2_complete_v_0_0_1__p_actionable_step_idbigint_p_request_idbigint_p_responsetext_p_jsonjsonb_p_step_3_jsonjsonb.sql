CREATE OR REPLACE FUNCTION public.app_orders_add_microservice_quantity_step_2_complete_v_0_0_1(p_actionable_step_id bigint, p_request_id bigint, p_response text, p_json jsonb, p_step_3_json jsonb)
