CREATE OR REPLACE FUNCTION public.app_billing_roles_sign_off_step_3_draft_v_0_0_1(p_actionable_step_id bigint, p_request_id bigint, p_json jsonb, p_response text DEFAULT NULL::text)
