CREATE OR REPLACE FUNCTION public.master_table_create_rls_delete_policy(p_master_table_id bigint)
 RETURNS void
 LANGUAGE plpgsql
 SECURITY DEFINER
...
DROP POLICY IF EXISTS rls_%1$s_delete ON %2$I.%1$I;



CREATE POLICY rls_%1$s_delete
...
CASE public.app_scope_policy_helper(%3$L,'delete')
    ...
    EXISTS (
        ...
        FROM jsonb_array_elements_text(
            ...
            COALESCE(
                ...
                (COALESCE(in_ref_master_user_uuid,'{}'::jsonb)->'Delete'),
