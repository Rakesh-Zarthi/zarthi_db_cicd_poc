CREATE OR REPLACE FUNCTION public.app_add_orders_step_3_draft_v_0_0_1(p_actionable_step_id bigint, p_request_id bigint, p_response text DEFAULT NULL::text, p_json jsonb DEFAULT NULL::jsonb)
